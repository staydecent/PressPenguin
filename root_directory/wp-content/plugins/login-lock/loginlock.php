...
define( 'WPSEC_LOGINLOCK_VERSION', '2.0' );
...
class LoginLock { 
	...
	function __construct() { 
		...
		add_action('plugins_loaded', array( &$this, 'll_styles') );
...
<?php
	...
	<?php   } else { ?>
	<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', network_home_url() ); ?>" title="<?php echo apply_filters('login_headerti
	tle', esc_attr($current_site->site_name) ); ?>"><span class="hide"><?php bloginfo('name'); ?></span></a></h1>
	<?php   }
